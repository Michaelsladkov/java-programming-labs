...
public class FieldsReader {
    ...
    public String readName() throws NoSuchElementException {
        ...
        while (name == null) {
            ...
            name = readLine();
            if (name == null) {
                writeMessage("your input doesn't contain name, try again");
            }
        }
        return name;
    }
    ...
    public Long readCoordinate(char axis) throws NoSuchElementException {
        ...
        while (coordinate == null) {
            ...
            try {
                ...
                writeMessage("your input doesn't contain coordinate, try again");
                coordinate = null;
            }
        }
        return coordinate;
    ...
    public Long readSalary() throws NoSuchElementException {
        ...
        while (salary == null) {
            ...
            try {
                ...
                if (salary <= 0) {
                    writeMessage("Salary should be more than 0");
                    salary = null;
                }
            } catch (NumberFormatException e) {
                writeMessage("your input doesn't contain salary, try again");
                salary = null;
            }
        }
        return salary;
    ...
    public ZonedDateTime readStartDate() throws NoSuchElementException {
        ...
        while (startDate == null) {
            ...
            try {
                ...
                writeMessage("your input doesn't contain date, try again");
                startDate = null;
            } catch (DateTimeParseException e) {
                writeMessage("Your format is incorrect. Use yyyy-mm-dd hh:mm:ss +/-hh:mm");
            }
        }
        return startDate;
    }
    ...
    public LocalDate readEndDate() throws NoSuchElementException {
        ...
        while (endDate == null) {
            ...
            try {
                ...
                writeMessage("Your format is incorrect. Use yyyy-mm-dd");
            }
        }
        return endDate;
    }
    ...
    public Color readColor(String fieldName) throws NoSuchElementException {
        Color color = null;
        while (color == null) {
            writeMessage("Enter one of following values for " + fieldName + " : ");
            for (Color declaredColor : Color.values()) {
                writeMessage(declaredColor.toString());
            }
            try {
                color = Color.valueOf(readLine().toUpperCase());
            } catch (IllegalArgumentException e) {
                writeMessage("Your input doesn't contain any of possible states. Try again");
                color = null;
            } catch (NullPointerException e) {
                break;
            }
    ...
    public Status readStatus() throws NoSuchElementException {
        Status status = null;
        while (status == null) {
            writeMessage("Enter one of following states: ");
            for (Status declaredStatus : Status.values()) {
                writeMessage(declaredStatus.toString());
            }
            try {
    ...
    public Double readHeight() throws NoSuchElementException {
        Double height = null;
        while (height == null) {
            writeMessage("Enter height: ");
            try {
                height = Double.parseDouble(readLine());
            } catch (NullPointerException e) {
                writeMessage("your input doesn't contain height, try again");
                height = null;
            } catch (NumberFormatException e) {
                writeMessage("You have used an incorrect number format");
            }
            if (height != null) if (height <= 0) {
                writeMessage("Height should be more than 0");
                height = null;
            }
        }
        return height;
    ...
    public Country readNationality() throws NoSuchElementException {
        ...
        while (nationality == null) {
            writeMessage("Enter one of following countries: ");
            for (Country declaredCountry : Country.values()) {
                writeMessage(declaredCountry.toString());
            }
            try {
                nationality = Country.valueOf(readLine().toUpperCase());
            } catch (IllegalArgumentException | NullPointerException e) {
                writeMessage("Your input doesn't contain any of possible countries. Try again");
                nationality = null;
            }
        }
        return nationality;
